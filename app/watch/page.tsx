    ...
    <div style={{background:"#0a0a0a", minHeight:"100vh", color:"#fff", padding:12}}>
      <div style={{maxWidth:900, margin:"0 auto"}}>
        ...
        <div style={{background:"#111", borderRadius:12, padding:10, marginTop:12}}>
          <div style={{fontSize:11, opacity:0.6, marginBottom:8, fontWeight:800}}>THIS TOURNAMENT ONLY - {players.length} PLAYERS (never in other 2):</div>
...
export default function WatchPage(){
  return (
    <Suspense fallback={<div style={{background:"#000", color:"#fff", padding:20, textAlign:"center"}}>Loading {`tournament`}...</div>}>
      <WatchContent />
    </Suspense>
  );
}
