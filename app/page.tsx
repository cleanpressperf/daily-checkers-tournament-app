...
function TournamentCard({ t }: { t: typeof tournaments[number] }) {
  function handleWatch(e: any) {
    e.preventDefault();
    const el = document.getElementById('watch-popup') as any; if (el) { el.style.display = 'flex'; }
  }
