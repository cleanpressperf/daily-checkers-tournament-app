...
function Nav() {
  ...
  return <header className="relative mx-auto flex w-full max-w-7xl items-center justify-between px-5 py-5 lg:px-10">
    ...
    <div className="hidden items-center gap-3 md:flex"><div className="flex items-center gap-2 rounded-full border border-white/15 px-4 py-2 text-sm"><CircleDollarSign className="size-4 text-[#d4a900]" />100</div><button className="rounded-full bg-white px-5 py-2 text-sm font-semibold text-black">CLEANpress</button></div>
